  ...
  return (
    <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl border-b border-stone-200">
      <div className="max-w-7xl mx-auto px-4 h-16 md:h-20 flex items-center justify-between gap-4 md:gap-8">
         ...
         >
            <div className="w-10 h-10 md:w-12 md:h-12 bg-[#ee4d2d] text-white rounded-2xl flex items-center justify-center font-black text-xl md:text-2xl shadow-xl shadow-orange-100 group-hover:scale-105 transition-transform">S</div>
            <div className="hidden sm:block">
               <h1 className="text-stone-900 text-xl md:text-2xl font-bold tracking-tight leading-none serif">StoryBali</h1>
               <p className="text-[8px] md:text-[9px] text-gray-400 font-black uppercase tracking-[0.3em]">Artisan Heritage</p>
            </div>
         </div>
         ...
         <div className="hidden md:flex flex-1 max-w-xl">
            <div className="relative w-full bg-stone-100 rounded-2xl flex items-center px-4 py-2 border border-transparent focus-within:border-[#ee4d2d]/20 focus-within:bg-white focus-within:shadow-lg transition-all">
               ...
               <input 
                 type="text" 
                 placeholder="Temukan keajaiban Bali..." 
               ...
               <span className="text-[10px] font-black text-gray-300 tracking-widest uppercase">Search</span>
            </div>
         </div>
         ...
         <div className="flex items-center gap-2 md:gap-6">
            <div className="hidden md:flex items-center gap-4 border-r border-stone-100 pr-6">
               ...
               <button onClick={() => onNavigate(AppRoute.ADMIN)} className="text-[10px] font-black uppercase tracking-widest text-stone-400 hover:text-[#ee4d2d] transition-colors">Seller Centre</button>
            </div>
